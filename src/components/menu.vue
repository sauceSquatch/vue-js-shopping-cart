  ...
  <div class="row">
    <div class="col-sm-12 col-md-6">
      <table class="table table-hover">
        ...
        <tbody v-for="item in getMenuItems" v-bind:key="item.key">
          <tr>
            <td>{{ item.name }}</td>
          </tr>
          <tr v-for="option in item.options" v-bind:key="option.key">
            <td>{{ option.size }}</td>
            <td>{{ option.price }}</td>
    ...
    <div class="col-sm-12 col-md-6">
      <div v-if="basket.length > 0">
        <table class="table">
          ...
          <tbody v-for="item in basket" v-bind:key="item.key">
            <tr>
              <td>
